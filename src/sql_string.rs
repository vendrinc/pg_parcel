...
lazy_static! {
    ...
    static ref POSTGRESQL_RESERVED_WORDS: HashSet<String> = {
        ...
        set.insert("array_​max_​cardinality".to_string());
        ...
        set.insert("character_​set_​catalog".to_string());
        ...
        set.insert("command_​function_​code".to_string());
        ...
        set.insert("current_​default_​transform_​group".to_string());
        ...
        set.insert("current_​transform_​group_​for_​type".to_string());
        ...
        set.insert("datetime_​interval_​code".to_string());
        set.insert("datetime_​interval_​precision".to_string());
        ...
        set.insert("dynamic_​function_​code".to_string());
        ...
        set.insert("parameter_​ordinal_​position".to_string());
        set.insert("parameter_​specific_​catalog".to_string());
        set.insert("parameter_​specific_​name".to_string());
        set.insert("parameter_​specific_​schema".to_string());
        ...
        set.insert("returned_​octet_​length".to_string());
        ...
        set.insert("transactions_​committed".to_string());
        set.insert("transactions_​rolled_​back".to_string());
        ...
        set.insert("user_​defined_​type_​catalog".to_string());
        set.insert("user_​defined_​type_​code".to_string());
        set.insert("user_​defined_​type_​name".to_string());
        set.insert("user_​defined_​type_​schema".to_string());
